    ...
    <x-modal wire:model="showingModal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <x-inputs.text
                    name="course.name"
                    label="{{ __('crud.courses.inputs.name') }}"
                    wire:model.defer="course.name"
                ></x-inputs.text>
                <x-inputs.text
                    name="course.description"
                    label="{{ __('crud.courses.inputs.description') }}"
                    wire:model.defer="course.description"
                ></x-inputs.text>
            </div>
